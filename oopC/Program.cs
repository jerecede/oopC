...
namespace oopC
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var duck1 = new Beast("paperino", new QuakBehaviour());
            var duck2 = new Beast("paperina", new QuakBehaviour());
            var dog1 = new Beast("pluto", new WoofBehaviour());
            var dog2 = new Beast("pippo", new WoofBehaviour());
